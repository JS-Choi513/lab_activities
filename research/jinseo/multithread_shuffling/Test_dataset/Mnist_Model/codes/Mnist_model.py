...
'''
CPU Util monitoring Test code
filename = '/media/js/test/cpu.log'
...
while True :      
  ...
  print("Pandas Load Data",time.time() - time0)  
  log2 = "Pandas Load Data\n"
  logWrite(log2)

  y_train = df_train['label']
  log2 = "Label Extraction\n"
  logWrite(log2)

  x_train = df_train.drop(['label'],axis=1)
  log2 = "Drop Label \n"
  logWrite(log2)
  #log3 = "train data colunm drop\n:"
  #logWrite(log3)
'''
time0 = time.time()  
df_train = pd.read_csv("/home/js/Mnist/integrated_train.csv")
...
#train_ds = tf.data.Dataset.from_tensor_slices((batching_img,batching_lab)).batch(32, num_parallel_calls=1)
...
model = MyModel()
#log4 = "model object allocation\n"
#logWrite(log4)
loss_object = tf.keras.losses.SparseCategoricalCrossentropy()
#log4 = "loss function obj allocation\n"
#logWrite(log4)
optimizer = tf.keras.optimizers.Adam()
#log4 = "optimizer obj allocation\n"
#logWrite(log4)
...
#log4 = "model evaluation func obj allocation\n"
#logWrite(log4)
...
#log4 = "model func definition\n"
#logWrite(log4)
EPOCHS = 10
#log4 = "test func definition\n"
#logWrite(log4)
