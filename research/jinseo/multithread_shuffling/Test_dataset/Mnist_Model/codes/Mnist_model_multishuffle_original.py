...
'''tf.data'''
#train_ds = tf.data.Dataset.from_tensor_slices((x_train, y_train)).batch(32, num_parallel_calls=10)#shuffle(10000).batch(32, num_parallel_calls=10)
