...
def numpy_shuffle():
    ...
    tmp_trainx = x_train[s]
    tmp_trainy = y_train[s]
    batching_img = tmp_trainx.reshape(-1,25,28,28,1)    
    batching_lab = tmp_trainy.reshape(-1,25)
    print("shuffling time",time.time()-time1)
    return batching_img, batching_lab
