...
def multi_shuffling(train_arr,label_arr,threadnum, seed_tt):
      ...
      with concurrent.futures.ThreadPoolExecutor(max_workers=threadnum) as executor:
        ...
        for exec1 in range(threadnum):
              ...
              job = executor.submit(part_shuffle,train_arr[offset_list[exec1]:range_list[exec1]], label_arr[offset_list[exec1]:range_list[exec1]], non_rnd_offset[exec1],non_rnd_range[exec1],exec1, seed_tt)
              jobs.append(job)
      concurrent.futures.wait(jobs,timeout=None) 

def part_shuffle(parted_train_arr, parted_label_arr, non_rnd_offset, non_rnd_range,exec1, seed_tmp):
      ...
      shuffled_train_result[non_rnd_offset: non_rnd_range] = parted_train_arr[0:].copy()
      shuffled_label_result[non_rnd_offset: non_rnd_range] = parted_label_arr[0:].copy()
...
multi_shuffling(x_train,y_train,24,1000)
