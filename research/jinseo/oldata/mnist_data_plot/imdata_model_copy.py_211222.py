...
def part_test(model_idx, batch_size):
      ...
      #print("raw loss",test_model_arr[model_idx].test_loss.result())
      #print("raw acc",test_model_arr[model_idx].test_accuracy.result()*100)
...
#훈련 쓰레드 
train_thread = threading.Thread(target=model_train, args=(6, 128))
...
for epoch in range(EPOCHS):
      ...
      #print("array object type",test_loss_arr)
      #print("array object type",test_accuracy_arr)
      if THREAD_NUM==1:
                  print (template.format(epoch+1,
                              model.train_loss.result(),
                              model.train_accuracy.result()*100,
                              test_model_arr[0].test_loss.result(),
                              test_model_arr[0].test_accuracy.result()*100)   )
      else:
